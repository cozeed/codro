  ...
  return (
    <div className="aui-thread-welcome-suggestion-display fade-in slide-in-from-bottom-2 animate-in fill-mode-both min-w-0 duration-200 nth-[n+14]:hidden @md:nth-[n+14]:block">
      <SuggestionPrimitive.Trigger send asChild>
        <Button
          variant="ghost"
          className="aui-thread-welcome-suggestion bg-background hover:bg-muted h-auto w-full flex-wrap items-start justify-start gap-1 rounded-md border px-1.5 py-1.5 text-left text-sm break-all whitespace-normal transition-colors @md:flex-col"
        >
...
const Composer: FC = () => {
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root w-full">
      <div className="bg-background focus-within:ring-ring/20 focus-within:border-ring/75 flex w-full items-end gap-2 rounded-md border px-2 py-2 transition-shadow focus-within:ring-2">
        <ComposerPrimitive.Input
          placeholder={t("operation.writeMessage")}
          className="aui-composer-input placeholder:text-muted-foreground/80 max-h-32 w-full flex-1 resize-none bg-transparent px-2 py-2 text-sm leading-snug outline-none"
          rows={1}
          autoFocus
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-muted text-foreground rounded-md px-3 py-2.5 text-sm wrap-break-word empty:hidden">
          <MessagePrimitive.Parts />
        </div>
  ...
  return (
    <MessagePrimitive.Root className="aui-edit-composer-wrapper mx-auto flex w-full max-w-(--thread-max-width) flex-col px-2 py-3">
      <ComposerPrimitive.Root className="aui-edit-composer-root bg-muted ml-auto flex w-full max-w-7/8 flex-col rounded-md">
        <ComposerPrimitive.Input
          className="aui-edit-composer-input text-foreground min-h-14 w-full resize-none bg-transparent p-3 text-sm outline-none"
          autoFocus
        />
